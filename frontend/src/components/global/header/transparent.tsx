                  ...
                  <NavigationMenuItem key={item._key}>
                    {item.href ? (
                      <NavigationMenuLink asChild>
                        <Button variant="ghost" asChild className={cn({"text-white hover:text-white/80 hover:bg-white/10": !scrolled})}>
                      ...
                      <>
                        <NavigationMenuTrigger 
                          className={cn("font-medium text-sm", {
                            "text-white hover:text-white/80 hover:bg-white/10": !scrolled,
                          })}
                        >
                          {navTitle}
                        </NavigationMenuTrigger>
          ...
          <div className="hidden lg:flex gap-4">
            {ctaButtons.map((button) => (
              <Button
                ...
                className={cn({
                  "bg-white text-primary hover:bg-white/90": !scrolled && button.variant === "default",
                  "border-white text-white hover:bg-white/10 hover:text-white": !scrolled && button.variant === "outline",
                })}
                asChild
              >
