...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources5-YA5G2NLO.js")
});
...
var RenderActionCollectionState = (0, import_react2.memo)((props) => {
  ...
  let t0;
  return $[0] !== actionProps || $[1] !== actions || $[2] !== children || $[3] !== group || $[4] !== onActionComplete ? (t0 = (0, import_jsx_runtime2.jsx)(GetHookCollectionState, { onReset: onActionComplete, hooks: actions, args: actionProps, group, children }), $[0] = actionProps, $[1] = actions, $[2] = children, $[3] = group, $[4] = onActionComplete, $[5] = t0) : t0 = $[5], t0;
});
...
var DocumentStatusBarActions = (0, import_react2.memo)(function() {
  ...
  if (actions.length === 0 || !editState)
    return null;
  let t4;
  return $[8] !== actions || $[9] !== editState || $[10] !== renderDocumentStatusBarActions ? (t4 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions, actionProps: editState, group: "default", children: renderDocumentStatusBarActions }), $[8] = actions, $[9] = editState, $[10] = renderDocumentStatusBarActions, $[11] = t4) : t4 = $[11], t4;
});
var HistoryStatusBarActions = (0, import_react2.memo)(function() {
  ...
  let t8;
  return $[12] !== historyActions || $[13] !== renderDocumentStatusBarActions || $[14] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions: historyActions, actionProps: t7, group: "default", children: renderDocumentStatusBarActions }), $[12] = historyActions, $[13] = renderDocumentStatusBarActions, $[14] = t7, $[15] = t8) : t8 = $[15], t8;
});
...
var DocumentPanelHeader = (0, import_react2.memo)((0, import_react2.forwardRef)(function(_props, ref) {
  const {
    ...
    editState && (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions, actionProps: editState, group: "paneActions", children: renderPaneActions }),
  ...
  ] }), [BackLink2, actions, editState, menuButtonNodes, onPaneClose, onPaneSplit, renderPaneActions, schemaType, showPaneGroupCloseButton, showSplitPaneButton, showSplitPaneCloseButton, t2, unstable_languageFilter]);
...
function DocumentStatusBar(props) {
  ...
  const $ = (0, import_react_compiler_runtime.c)(22), {
    ...
    title
  } = useDocumentTitle(), CreateLinkedActions = (_a = useSanityCreateConfig().components) == null ? void 0 : _a.documentLinkedActions, showingRevision = !!revisionId, [collapsed, setCollapsed] = (0, import_react2.useState)(null), [rootElement, setRootElement] = (0, import_react2.useState)(null);
  let t0;
  ...
  bb0: {
    ...
    if (selectedPerspective) {
      if (isPublishedPerspective(selectedPerspective)) {
        t2 = isReady && !!(editState == null ? void 0 : editState.published);
        break bb0;
      }
      if (isReleaseDocument(selectedPerspective)) {
        t2 = isReady && !!(editState == null ? void 0 : editState.version);
        break bb0;
      }
    }
    t2 = isReady;
  }
  const shouldRender = t2;
  let actions;
  if (createLinkMetadata && isSanityCreateLinked(createLinkMetadata) && CreateLinkedActions) {
    let t32;
    $[3] !== CreateLinkedActions || $[4] !== createLinkMetadata || $[5] !== onDocumentChange || $[6] !== title ? (t32 = (0, import_jsx_runtime2.jsx)(CreateLinkedActions, { metadata: createLinkMetadata, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT, onDocumentChange, documentTitle: title }), $[3] = CreateLinkedActions, $[4] = createLinkMetadata, $[5] = onDocumentChange, $[6] = title, $[7] = t32) : t32 = $[7], actions = t32;
  } else if (showingRevision) {
    let t32;
    $[8] === Symbol.for("react.memo_cache_sentinel") ? (t32 = (0, import_jsx_runtime2.jsx)(HistoryStatusBarActions, {}), $[8] = t32) : t32 = $[8], actions = t32;
  } else {
    let t32;
    $[9] === Symbol.for("react.memo_cache_sentinel") ? (t32 = (0, import_jsx_runtime2.jsx)(DocumentStatusBarActions, {}), $[9] = t32) : t32 = $[9], actions = t32;
  }
  const t3 = showingRevision ? "revision" : "published";
  let t4;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t4 = {
    opacity: 0.2
  }, $[10] = t4) : t4 = $[10];
  ...
  const t6 = showingRevision ? "caution" : void 0;
  let t7;
  $[12] !== actions || $[13] !== actionsBoxRef || $[14] !== collapsed || $[15] !== shouldRender || $[16] !== showingRevision ? (t7 = shouldRender && (0, import_jsx_runtime2.jsxs)(Flex, { align: "stretch", gap: 1, justify: "space-between", paddingLeft: showingRevision ? 0 : 1, paddingRight: showingRevision ? 0 : 1, children: [
  ...
  ] }), $[12] = actions, $[13] = actionsBoxRef, $[14] = collapsed, $[15] = shouldRender, $[16] = showingRevision, $[17] = t7) : t7 = $[17];
  let t8;
  return $[18] !== t3 || $[19] !== t6 || $[20] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(AnimatedCard, { initial: t4, animate: t5, tone: t6, radius: 3, ref: setRootElement, sizing: "border", padding: 2, children: t7 }, t3), $[18] = t3, $[19] = t6, $[20] = t7, $[21] = t8) : t8 = $[21], t8;
}
...
var DocumentActionShortcuts = (0, import_react2.memo)((props) => {
  ...
  if (!actionProps || !actions)
    return null;
  let t5;
  return $[14] !== actionProps || $[15] !== actions || $[16] !== renderDocumentActionShortcuts ? (t5 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actionProps, actions, children: renderDocumentActionShortcuts }), $[14] = actionProps, $[15] = actions, $[16] = renderDocumentActionShortcuts, $[17] = t5) : t5 = $[17], t5;
});
...
function getCompareVersionsItem({
  ...
  const isDisabled = typeof (documentIdStack == null ? void 0 : documentIdStack.previousId) > "u";
...
function DocumentLayoutFooter(t0) {
  ...
  let t4;
  $[4] !== StartInCreateBanner || $[5] !== documentId || $[6] !== isInitialValueLoading || $[7] !== ready || $[8] !== schemaType || $[9] !== value ? (t4 = StartInCreateBanner && (0, import_jsx_runtime2.jsx)(ShowWhenPaneOpen, { children: (0, import_jsx_runtime2.jsx)(StartInCreateBanner, { document: value, documentId, documentType: schemaType, documentReady: ready, isInitialValueLoading: !!isInitialValueLoading, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT }) }), $[4] = StartInCreateBanner, $[5] = documentId, $[6] = isInitialValueLoading, $[7] = ready, $[8] = schemaType, $[9] = value, $[10] = t4) : t4 = $[10];
  let t5;
  $[11] !== createLinkMetadata || $[12] !== setActionsBoxElement ? (t5 = (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime2.jsx)(DocumentStatusBar, { actionsBoxRef: setActionsBoxElement, createLinkMetadata }) }), $[11] = createLinkMetadata, $[12] = setActionsBoxElement, $[13] = t5) : t5 = $[13];
  let t6;
  $[14] !== setFooterElement || $[15] !== t4 || $[16] !== t5 ? (t6 = (0, import_jsx_runtime2.jsxs)(PaneFooter, { ref: setFooterElement, padding: 1, children: [
    t4,
    t5
  ] }), $[14] = setFooterElement, $[15] = t4, $[16] = t5, $[17] = t6) : t6 = $[17];
  let t7;
  $[18] !== t6 || $[19] !== zOffsets.portal ? (t7 = (0, import_jsx_runtime2.jsx)(DialogProvider, { position: DIALOG_PROVIDER_POSITION$1, zOffset: zOffsets.portal, children: t6 }), $[18] = t6, $[19] = zOffsets.portal, $[20] = t7) : t7 = $[20];
  let t8;
  return $[21] !== portalElements || $[22] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(PortalProvider, { __unstable_elements: portalElements, children: t7 }), $[21] = portalElements, $[22] = t7, $[23] = t8) : t8 = $[23], t8;
}
...
var DocumentPaneProvider = (0, import_react2.memo)((props) => {
  const {
    ...
    return revisionId !== null || isDeleting || isDeleted;
  }, [getIsDeleted, isDeleting, revisionId]), getDisplayed = (0, import_react2.useCallback)((value) => onOlderRevision ? revisionDocument || {
    _id: value._id,
    _type: value._type
...
var DocumentEventsPane = (props) => {
  ...
  let t4;
  const t5 = eventsStore.error, t6 = ((_b = eventsStore.revision) == null ? void 0 : _b.revisionId) || null, t7 = !!(((_c = eventsStore.revision) == null ? void 0 : _c.document) && ((_d = eventsStore.revision) == null ? void 0 : _d.revisionId)), t8 = ((_e = eventsStore.revision) == null ? void 0 : _e.document) || null, t9 = ((_f = eventsStore.sinceRevision) == null ? void 0 : _f.document) || null, t10 = !eventsStore.loading, t11 = eventsStore.events.length === 0;
  let t12;
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-4QLGFMES.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-BABVTRBZ.js.map
